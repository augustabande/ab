...
const AccordionExample = () => {
    return (
        <div id="accordion">  <br></br>
            <h5>Details</h5>
            <Accordion id="accordion-example" defaultActiveKey="0">
                <Card>
                    <Card.Header>
                    ...
                    <Accordion.Collapse eventKey="1">
                        <Card.Body>
                            <ul>
                                ...
                                <li>You are searching for an SEO specialist for strategic planning and sector-specific advice</li>
                            </ul>
                        </Card.Body>
                    </Accordion.Collapse>
                </Card>
            ...
            <h5>How it works</h5>
            <Accordion id="accordion-example2" defaultActiveKey="0">
                <Card>
                    <Card.Header>
                        <Accordion.Toggle as={ Button } variant="link" eventKey="0">
